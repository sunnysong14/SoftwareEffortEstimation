function [tInd,eInd] = myCrossvalind(method, seed, N,varargin)
% 
% REVISION
%   Add random seed to control the randomness. One can refer matlab HELP
%   for 'crossvalind' except that this script has an additional input
%   argument, namely seed.
% 
% Copyright of the small revision 2016-12: Liyan Song
...
rng(seed);  % Liyan: to contrl the randomness
